...
class Robot:
    def __init__(self, dt):
        ...
        # Observer module
        self.observer = Observer_Dynamics(self.dt, self.gear_ratio, self.max_angular_vel_motor, self.wheels_radius,
                                          self.wheels_base_lenght)
        ...
        self.Current_Frame = numpy.array(
            [[math.cos(self.Current_Pose[2]), -1 * math.sin(self.Current_Pose[2]), self.Current_Pose[0]],
    ...
    def update_current_state(self):
        ...
        self.Current_Pose = self.observer.Compute_new_robot_pose(self.Current_Pose,
        self.trace_motor_speeds.pop())  # update the current frame of the robot
    ...
    def reset_current_state(self):
        ...
        self.trace.append(self.Current_Pose)
        # update the current robot position
        self.Current_Pose = self.assumed_Current_Pose  # update the current frame of the robot
        self.update_current_frame()  # update the current frame of the robot
