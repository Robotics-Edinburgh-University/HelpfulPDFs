...
class MapRoom:
    ...
    def waypoint_computation(self):
        ...
        waypoint_info = {'coord': numpy.array(roomA.e) + numpy.array([-1*self.exit_dist_param, 0.]),
                         'room': "A",
                         'name': "EXIT_A",
                         'priority_axis': "y",
                         'id': len(waypoint_list)}
        ...
        waypoint_roomB_exit = waypoint_roomB_exit + numpy.array([10,0])
        ...
        waypoint_info = {'coord': numpy.array(roomB.g) + numpy.array([self.exit_dist_param, 0.]),
                         'room': "B",
                         'name': "EXIT_B",
                         'priority_axis': "y",
                        'id': len(waypoint_list)}
        ...
        waypoint_info = {'coord': numpy.array(roomC.d) + numpy.array([ 0., self.exit_dist_param ]),
                         'room': "C",
                         'name': "EXIT_C",
                         'priority_axis': "x",
                        'id': len(waypoint_list)}
        ...
        waypoint_info = {'coord': numpy.array(roomD.d) + numpy.array([ 0., -1*self.exit_dist_param ]),
                         'room': "D",
                         'name': "EXIT_D",
                         'priority_axis': "x",
                         'id': len(waypoint_list)}
        ...
        waypoint_roomE_exit = waypoint_roomE_exit + numpy.array([-10,0])
        ...
        waypoint_info = {'coord': numpy.array(roomE.g) + numpy.array([ -1*self.exit_dist_param, 0. ]),
                         'room': "E",
                         'name': "EXIT_E",
                         'priority_axis': "y",
                         'id': len(waypoint_list)}
        ...
        waypoint_info = {'coord': numpy.array(roomF.e) + numpy.array([ self.exit_dist_param, 0. ]),
                         'room': "F",
                         'name': "EXIT_F",
                         'priority_axis': "y",
                         'id': len(waypoint_list)}
